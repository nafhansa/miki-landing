      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="feature-row flex flex-col lg:flex-row items-center gap-12 lg:gap-24 mb-32">
          <div className="w-full lg:w-1/2">
            <div className="w-12 h-12 bg-blue-normal/10 rounded-xl flex items-center justify-center text-blue-normal mb-6">
              <ScanLine size={24} />
            </div>
            ...
            <ul className="space-y-3">
              {['98% Accuracy', 'Detects Sauces & Oils', 'Instant Macro Calculation'].map((item, i) => (
                <li key={i} className="flex items-center gap-3 text-gray-300 font-medium">
                  <span className="w-2 h-2 rounded-full bg-blue-normal"></span>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative w-full max-w-md mx-auto aspect-square bg-black rounded-[2rem] overflow-hidden border border-white/10 group">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 border-2 border-blue-normal rounded-xl flex items-end justify-start p-0 overflow-hidden shadow-[0_0_15px_rgba(var(--color-blue-normal-rgb),0.5)]">
                 <div className="bg-blue-normal text-black text-[10px] px-2 py-1 font-bold absolute bottom-0 left-0">Salad Bowl</div>
              </div>
              
              <div className="absolute left-0 right-0 h-0.5 bg-blue-normal shadow-[0_0_20px_rgba(var(--color-blue-normal-rgb),0.8)] top-0 group-hover:top-full transition-all duration-[2500ms] ease-linear"></div>
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-sm p-4 rounded-xl border border-white/10 z-10">
                ...
                <div className="w-full bg-white/20 h-2 rounded-full overflow-hidden">
                  <div className="bg-blue-normal h-full w-[85%]"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="feature-row flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-24 mb-32">
          <div className="w-full lg:w-1/2">
            <div className="w-12 h-12 bg-purple-normal/10 rounded-xl flex items-center justify-center text-purple-normal mb-6">
              <Activity size={24} />
            </div>
            <h3 className="text-3xl font-bold text-white mb-4">
             ...
             <div className="relative w-full max-w-md mx-auto aspect-square bg-black rounded-[2rem] overflow-hidden border border-white/10 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center">
                  <div className="relative inline-block">
                    <div className="absolute inset-0 bg-dpurple-normal rounded-full blur-2xl opacity-20 animate-ping"></div>
                  ...
                  <div className="mt-8 bg-white/10 backdrop-blur-md px-6 py-3 rounded-xl border border-white/10">
                    ...
                    <div className="flex items-center gap-2 justify-center">
                       <span className="w-3 h-3 bg-blue-normal rounded-full animate-pulse"></span>
        ...
        <div className="feature-row flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-1/2 relative">
             <div className="relative w-full max-w-md mx-auto aspect-square bg-black rounded-[2rem] overflow-hidden border border-white/10">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 border border-blue-normal/30 rounded-full absolute animate-[ping_3s_linear_infinite]"></div>
                  <div className="w-48 h-48 border border-purple-normal/50 rounded-full absolute animate-[ping_3s_linear_infinite_1s]"></div>
                </div>

                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-purple-normal border-4 border-white rounded-full shadow-lg z-20"></div>
